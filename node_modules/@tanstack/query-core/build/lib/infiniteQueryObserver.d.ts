import type { DefaultedInfiniteQueryObserverOptions, FetchNextPageOptions, FetchPreviousPageOptions, InfiniteData, InfiniteQueryObserverOptions, InfiniteQueryObserverResult, QueryKey } from '@tanstack/query-core/build/lib/types';
import type { QueryClient } from '@tanstack/query-core/build/lib/queryClient';
import type { NotifyOptions, ObserverFetchOptions } from '@tanstack/query-core/build/lib/queryObserver';
import { QueryObserver } from '@tanstack/query-core/build/lib/queryObserver';
import type { Query } from '@tanstack/query-core/build/lib/query';
